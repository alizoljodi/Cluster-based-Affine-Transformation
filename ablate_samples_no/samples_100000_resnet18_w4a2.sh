#!/bin/bash
#SBATCH -J R18_W4A2_SAMPLES_100000
#SBATCH -c 8
#SBATCH --mem=128G
...
echo "Starting ResNet18 W4A2 with 100000 samples experiment at $(date)"
...
echo "Completed ResNet18 W4A2 with 100000 samples experiment at $(date)"
