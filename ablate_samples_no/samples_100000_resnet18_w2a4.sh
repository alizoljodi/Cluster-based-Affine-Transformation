#!/bin/bash
#SBATCH -J R18_W2A4_SAMPLES_100000
#SBATCH -c 8
#SBATCH --mem=128G
...
echo "Starting ResNet18 W2A4 with 100000 samples experiment at $(date)"
...
echo "Completed ResNet18 W2A4 with 100000 samples experiment at $(date)"
