...
echo "This will run experiments for sample counts: 10, 50, 100, 500, 1000, 5000, 10000, 100000, 200000, 500000, 1000000"
...
echo "Total experiments: 11 sample counts × 4 bitwidth combinations × 3 seeds = 132 experiments"
echo ""

# Define sample values and bitwidth combinations
sample_counts=(10 50 100 500 1000 5000 10000 100000 200000 500000 1000000)
