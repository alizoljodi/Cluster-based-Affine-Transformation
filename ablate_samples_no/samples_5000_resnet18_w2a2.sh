#!/bin/bash
#SBATCH -J R18_W2A2_SAMPLES_5000
#SBATCH -c 8
#SBATCH --mem=128G
...
echo "Starting ResNet18 W2A2 with 5000 samples experiment at $(date)"
...
echo "Completed ResNet18 W2A2 with 5000 samples experiment at $(date)"
