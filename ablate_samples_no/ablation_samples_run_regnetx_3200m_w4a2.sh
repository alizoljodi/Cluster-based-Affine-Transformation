#!/bin/bash
#SBATCH -J REG3200_W4A2_SAMPLES_ABLATION
#SBATCH -c 8
#SBATCH --mem=128G
...
echo "Starting RegNetX-3200M W4A2 samples ablation experiment at $(date)"
...
echo "Completed RegNetX-3200M W4A2 samples ablation experiment at $(date)"
