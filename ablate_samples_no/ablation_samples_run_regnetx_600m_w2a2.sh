#!/bin/bash
#SBATCH -J REG600_W2A2_SAMPLES_ABLATION
#SBATCH -c 8
#SBATCH --mem=128G
...
echo "Starting RegNetX-600M W2A2 samples ablation experiment at $(date)"
...
echo "Completed RegNetX-600M W2A2 samples ablation experiment at $(date)"
