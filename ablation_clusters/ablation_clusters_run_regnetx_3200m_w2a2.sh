...
python run_script_seed.py regnetx_3200m --w_bits 2 --a_bits 2 --num_seeds 3 --start_seed 0 --sleep 0.5 --alpha 0.6 --num_clusters 1 8 16 24 32 48 64 96 128 192 256 --pca_dim 50
