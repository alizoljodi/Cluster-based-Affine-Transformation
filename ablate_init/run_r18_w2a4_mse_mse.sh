...
python ../run_script_seed.py resnet18 --w_bits 2 --a_bits 4 --num_seeds 10 --start_seed 0 --sleep 0.5 --alpha 0.5 --num_clusters 56 --pca_dim 40 --init_wmode mse --init_amode mse --use_enhanced_cat False
