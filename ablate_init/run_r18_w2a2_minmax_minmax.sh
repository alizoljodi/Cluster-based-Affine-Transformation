...
python run_script_seed.py resnet18 --w_bits 2 --a_bits 2 --num_seeds 10 --start_seed 0 --sleep 0.5 --alpha 0.4 --num_clusters 1 --pca_dim 1 --init_wmode minmax --init_amode minmax --use_enhanced_cat False
